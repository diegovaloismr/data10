...
readingTime: 9
cover: "./covers/copa-2026.svg"
coverAlt: "Ilustração abstrata de um globo estilizado com pontos conectados sobre um mapa, representando a Copa do Mundo 2026"
---

A Copa do Mundo de 2026 já entra para a história por ser a primeira com 48 seleções e a primeira sediada por três países ao mesmo tempo — Estados Unidos, México e Canadá. Mas, para quem acompanha o esporte pela lente dos dados, o torneio deixou outro legado: foi o Mundial em que a infraestrutura de coleta de dados virou, ela mesma, parte da história tanto quanto os resultados em campo. Reunimos aqui os números e as tecnologias que mais chamaram atenção.
...
Mais revelador que a artilharia, porém, foi quem levou a Bola de Ouro de melhor jogador do torneio: **Rodri**, volante da Espanha — um reconhecimento a um perfil de jogador cuja contribuição não aparece em gols ou assistências, mas em construção, progressão de bola e controle de jogo. É um retrato exato do tipo de valor que métricas como o [xT (Expected Threat)](/pt/blog/expected-threat-xt/) tentam capturar numericamente.
...
Esse é exatamente o tipo de infraestrutura que discutimos, em mais profundidade, no artigo [Visão computacional e tracking data: como a IA passou a enxergar o futebol](/pt/blog/visao-computacional-tracking-data/) — a Copa de 2026 funcionou como uma vitrine em escala global do que já vinha acontecendo, de forma mais isolada, em ligas e clubes de ponta.
...
Para acompanhar dados reais e atualizados diariamente do Brasileirão e das principais ligas europeias, visite nossos [dashboards](/pt/dashboards/brasileirao/). E se você ainda não domina o vocabulário básico dessa área, comece pelo nosso [glossário completo](/pt/glossario/).

**Fontes:** [Wikipédia — Final da Copa do Mundo FIFA de 2026](https://pt.wikipedia.org/wiki/Final_da_Copa_do_Mundo_FIFA_de_2026), [FIFA — Golden Boot 2026](https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/articles/adidas-golden-boot-race-top-scorer), [NPR — Spain 2026 World Cup champion](https://www.npr.org/2026/07/19/nx-s1-5899071/2026-world-cup-fifa-argentina-spain-final-championship).
